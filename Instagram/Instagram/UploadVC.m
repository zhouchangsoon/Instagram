...
- (void)alignment {
    ...
    self.introText.frame = CGRectMake(self.picImg.frame.size.width + 25, self.picImg.frame.origin.y, width - self.introText.frame.origin.x - 10, self.picImg.frame.size.height);
